...
class _QRViewScreenState extends State<QRViewScreen> {
  ...
  void _convertQRToImage() {
    ...
    try {
      ...
      if (_qrCode!.startsWith('data:image/png') || _qrCode!.startsWith('data:image/jpeg')) {
        final String base64String = _qrCode!.split(',').last;
        _qrImageBytes = base64.decode(base64String);
      }
      // Si es una URL normal o data URI de otro tipo
      else if (_qrCode!.startsWith('http') || _qrCode!.startsWith('data:image')) {
        _qrImageBytes = null;
      }
    } catch (e) {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'URL: ${Environment.production}/trazabilidad/',
              textAlign: TextAlign.center,
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton.icon(
            ...
            label: const Text('Regenerar QR', style: TextStyle(color: Colors.white)),
            style: ElevatedButton.styleFrom(
